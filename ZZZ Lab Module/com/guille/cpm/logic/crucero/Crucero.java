...
public class Crucero implements CanBeFull {
	...
	/**
	 * Return the starting price Before applying the discount of a cruise.
	 * 
	 * @return the starting price Before applying the discount of a cruise.
	 */
	...
	/**
	 * Return the trip that matches the date given as the parameter.
	 * 
	 * @param d is the date of the trip.
	 * @return the trip if it exits.
	 * @throws IllegalStateException if the trip does not exist.
	 */
